...
.mode list
.separator " | "
.output YourName_Tutorial01_out.txt
.open TUT1.db
...
CONSTRAINT shipment_line_ship_id_fk FOREIGN KEY (ship_id) REFERENCES
shipment(ship_id),
CONSTRAINT shipment_line_inv_id_fk FOREIGN KEY (inv_id) REFERENCES
inventory(inv_id),
...
CONSTRAINT order_line_o_id_fk FOREIGN KEY (ol_o_id) REFERENCES orders(ord_id),
CONSTRAINT order_line_inv_id_fk FOREIGN KEY (ol_inv_id) REFERENCES
inventory(inv_id),
CONSTRAINT order_line_oid_invid_pk PRIMARY KEY (ol_o_id, ol_inv_id));
--- inserting records into CUSTOMER
INSERT INTO CUSTOMER VALUES
(1, 'Tulu', 'Bengisu', NULL, date('1967-12-10'), '9815 Circle Dr.', NULL, NULL,
'Tallahassee', 'FL', '32308', '9045551897', '904558599', 'tulub', 'barbiecar');
INSERT INTO CUSTOMER VALUES
(2, 'Elmes', 'Michael', 'B', date('1958-08-14'), '172 Alto Park', NULL, NULL,
'Seattle', 'WA','42180', '4185551791', '4185556643', 'elmesmb', 'qwert5');
INSERT INTO CUSTOMER VALUES
(3, 'Strong', 'Diana', 'M', date('1960-04-12'), '850 East Main', NULL, NULL, 'Santa
Ana', 'MA', '51875', '3075557841', '3075559852', 'strongdm', 'joshua5');(item_id CHAR(4),
item_desc VARCHAR(30),
item_cat_id CHAR(3),
CONSTRAINT item_id_pk PRIMARY KEY (item_id),
CONSTRAINT item_cat_id_fk FOREIGN KEY (item_cat_id) REFERENCES category(cat_id));
...
INSERT INTO CUSTOMER VALUES
(3, 'Strong', 'Diana', 'M', date('1960-04-12'), '850 East Main', NULL, NULL, 'Santa
Ana', 'MA', '51875', '3075557841', '3075559852', 'strongdm', 'joshua5');
INSERT INTO CUSTOMER VALUES
(4, 'Eleanor', 'Loiacono', 'T', date('1981-01-18'), '994 Kirkman Rd.', NULL, NULL,
'Northpoint', 'NY', '11795', '4825554788', '4825558219', 'eleanorlt', 'hold98er');
INSERT INTO CUSTOMER VALUES
(5, 'Wulf', 'Sharon', 'A', date('1978-08-30'), '195 College Blvd.', NULL, NULL,
'Newton', 'GA', '37812', '3525554972', '3525551811', 'wulfsa', '125pass');
INSERT INTO CUSTOMER VALUES
(6, 'Wilkinson', 'Norm', 'D', date('1973-06-01'), '348 Rice Lane', NULL, NULL,
'Radcliff', 'WY', '87195', '7615553485', '7615553319', 'wilkinsonnd', 'nok$tell');
